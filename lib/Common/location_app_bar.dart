...
class LocationAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AppBar(
      ...
      ), // Replace with your A&W logo
      title: Align(
        // 外层Align用于将整个包裹的Container靠右
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: primaryColor.withAlpha(18), // 整个大框的背景色
            border: Border.all(
          ...
          child: Row(
            ...
            children: [
              ...
              RawMaterialButton(
                ...
                elevation: 0, // 默认不显示阴影
                fillColor: primaryColor.withAlpha(24), // 按钮背景色
